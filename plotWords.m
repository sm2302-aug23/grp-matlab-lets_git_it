...
letterMap('a') = [1 3; 0.25 2.5; 0.5 1.75; 0.9 2; 0.9 2; 1 2.5; 1 3; 1 2.5; 1 2.25; 1.25 1.75;1.75 2.5];
letterMap('b') = [0.5 2.5; 1.125 3.25; 1.75 4.25; 1.625 5.25; 1.25 2.5; 1.75 3.25; 2 2; 1.375 1.5; 1.125 2; 2.75 2.5];
letterMap('f') = [0.5 2.5; 1 2.875; 1.5 3.5; 1.625 4.25; 1.25 4.5; 1 3.5; 0.875 2.375; 0.8125 1.5; 1 1.0625; 
    1.25 1.5; 1.17 2; 0.875 2.375; 1.625 2.5];
letterMap('i') = [2.75 2.5; 3.25 3; 3.375 3.25; 3.125 2.25; 3.375 1.75; 3.75 2.5];
letterMap('l') = [0.25 2.50; 1 3.375; 1.625 3.875; 1.75 4.5; 1.50 4.875; 1.125 4.25; 1 3.375; 1.125 2.125; 1.375 1.8125;
     1.75 2.5];
letterMap('q') = [1.25 3.375; 0.75 3.375; 0.375 3; 0.25 2.5; 0.5 2.25; 1 2.75; 1.25 3.375; 1 2.75; 0.875 2; 
    1 0.5; 1.375 1.375; 0.875 2; 1.75 2.5];
letterMap('s') = [1.25 3.5; 0.75 3.8; 0.5 3.5; 0.75 3; 1.375 1.625; 0.75 0.875; 0.375 1.5; 1.75 2.5];
letterMap('y') = [0.5 2.5; 0.55 2.55; 0.6 2.6; 0.75 2.75; 1 2; 1.5 2.75; 1.5 1.5; 1.25 0.5; 0.5 0.25; 0.5 1; 2.25 2.5];
